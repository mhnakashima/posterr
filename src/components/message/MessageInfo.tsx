interface MessageInfoProps {
  messageInfoHeaderText: string;
  messageInfoBodyText: string;
}
      ...
      <div className="flex">
        <div className="py-1">
          <svg
            ...
            viewBox="0 0 20 20"
          >
            <path d="M10 18a8 8 0 1 1 0-16 8 8 0 0 1 0 16zm0-2a6 6 0 1 0 0-12 6 6 0 0 0 0 12zM10 12a2 2 0 1 1 0-4 2 2 0 0 1 0 4z" />
          </svg>
        </div>
        <div>
