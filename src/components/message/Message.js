const Message = () => {
    return (
        <div className="bg-gray-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-md" role="alert">
            <div className="flex">
                ...
                <div>
                    ...
                    <p className="text-sm">There's no post available. What do you think to click on all posts and see what the community has been posting?</p>
                </div>
            </div>
        </div>
    )
